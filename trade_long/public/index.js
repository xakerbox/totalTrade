...
const zeroBuy = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const getPositionInfo = yield binance.getCoinInPosition(coin);
    ...
    const allMiddleOrders = countOrders_1.generateMiddleOrders(recountedMiddlePrices, recountedQty, calc.coin, tickerSize);
    ...
    switch (allExistingOrders.length) {
        ...
        case 5:
            if (tierArray[1] === 0) {
                ...
                const [{ positionAmt, entryPrice }] = yield binance.getCoinInPosition(coin);
                ...
                yield telegram.sendMiddlePut(coin, 1, +positionAmt, limitPrice);
                tierArray[1] = 1;
            }
            break;
        ...
        case 4:
            if (tierArray[2] === 0) {
                ...
                yield telegram.sendMiddlePut(coin, 2, +positionAmt, limitPrice);
                tierArray[2] = 1;
            }
            break;
        ...
        case 3:
            if (tierArray[3] === 0) {
                ...
                yield telegram.sendMiddlePut(coin, 3, +positionAmt, limitPrice);
                tierArray[3] = 1;
                break;
            }
        ...
        case 2:
            if (tierArray[4] === 0) {
                ...
                yield telegram.sendMiddlePut(coin, 4, +positionAmt, limitPrice);
                tierArray[4] = 1;
            }
            break;
        ...
        case 1:
            if (tierArray[5] === 0) {
                ...
                yield telegram.sendMiddlePut(coin, 5, +positionAmt, limitPrice);
                tierArray[5] = 1;
            }
            break;
    }
